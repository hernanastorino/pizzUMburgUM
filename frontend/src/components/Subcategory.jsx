...
const Subcategory = ({ subcategory, onUpdate, onDelete, onDeleteOption }) => {
  const [isOpen, setIsOpen] = useState(false);
  const [isEditingName, setIsEditingName] = useState(!subcategory.name || subcategory.name === 'Nueva Subcategoría');
  const [name, setName] = useState(subcategory.name || '');

  // TÍTULOS DE COLUMNAS - Usar customTitles si existen, sino vacío
      ...
      {isOpen && (
        <div className={styles.subcategoryContent}>
          <div className={styles.subcategoryInner}>
            ...
            {/* ENCABEZADO ALINEADO - Solo mostrar si hay customTitles */}
